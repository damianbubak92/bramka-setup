/** \addtogroup module_scif_osal Operating System Abstraction Layer
  ...
  *
  * The SCIF driver performs I/O initialization internally without use of the \b PIN or \b GPIO driver
  * for TI-RTOS. The System CPU application should not use the PIN or GPIO driver to initialize or open
  * any I/O pins used by Sensor Controller. The \ref module_scif_driver_setup defines the DIO numbers of
  * all mapped I/O pins, allowing for compile-time checking of the I/O mapping.
  *
