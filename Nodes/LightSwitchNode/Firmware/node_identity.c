 ...
 * (CC1310_LAUNCHXL.c: flashBuf @ 0x1A000, CONFIG_NVSINTERNAL). The address is a
...
#include "ti_drivers_config.h"   /* CONFIG_NVSINTERNAL (SysConfig) */
 ...
 * multiple of 4 bytes. */
#define IDENTITY_MAGIC  0x4C534E31u   /* "LSN1" - Light Switch Node v1 */
...
void identity_init(void)
{
    ...
    sNvs = NVS_open(CONFIG_NVSINTERNAL, &params);
    if (sNvs == NULL) {
